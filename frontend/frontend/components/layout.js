...
export default function Layout({ children, pageTitle = "Social Media Project" }) { 
    return (
        <div className="flex flex-col min-h-screen bg-gray-100"> {/* 1. 設定為 flex 容器，垂直排列，最小高度為螢幕高度，加上一個淺灰色背景 */}
            <Head>
